...
//pour pouvoir utiliser l'enchainement a la suite de plusieurs methode il faut retourner this
...
var_dump($content);
$date = $this->date;/*$this->date("Y-m-d H:i:s");*///$this->date->format('d/m/Y');
var_dump($date);
...
$article->setTitle($titre)->setContent($texte_de_contenu)->setDate(date("Y-m-d H:i:s"))->saveInDatabase();
var_dump($article);
